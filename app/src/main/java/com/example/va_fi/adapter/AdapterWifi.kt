...
class AdapterWifi(private val list:List<WifiUrl>, private val onClickWifiItem: OnClickWifiItem):RecyclerView.Adapter<AdapterWifi.WifiViewHolder>(){
  inner class WifiViewHolder(val wifiItemBinding: WifiItemBinding):RecyclerView.ViewHolder(wifiItemBinding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WifiViewHolder {
       return WifiViewHolder(WifiItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
